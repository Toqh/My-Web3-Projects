...
const initApp = () => {
  ...
  //get all the accounts that are available from metamask
  let accounts = [];
  ...
  $edit.addEventListener('submit', e=> {
    ...
    crud.methods
      ...
      .catch(() => {
          $editResult.innerHTML =  `Ooops.. there was a problem while trying to change user ${id}`;
      })
  ...
  $delete.addEventListener('submit', e=> {
    ...
    crud.methods
      ...
      .catch(() => {
          $deleteResult.innerHTML =  `Ooops.. there was a problem while trying to delete user ${id}`;
